...
```
Quickly loooking at the plot, it looks like the effect of age has a relatively minimal if any effect on the amount of hair growth and that BaldBeGone is a better treatment than SkinHeadNoMore which in turn appears to be a better treatment that Luxuriant. It also appears that all three of the treatments are btter than the placebo. We will now perform statistical tests in order to see if these eye checks hold up to scrutiny. 
