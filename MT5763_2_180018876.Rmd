...
Group = 'Luxuriant'; \* Creating a new variable called 
RUN;
...
In order to accomplish this first I will use a Macro from the notes (slightly modified) to perform a random 2 sample difference of means t-test.
```
