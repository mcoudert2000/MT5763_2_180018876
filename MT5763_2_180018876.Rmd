...
SET PROJECT2.SkinHeadNoMore PROJECT2.Luxuriant PROJECT2.Placebo PROJECT2.BaldBeGone; \* Listing the datasets 
RUN;
```
...
Length = Length * 25.4; \* Inches to (mm)
RUN;
```
...
It is clear that age does not have a statistically significant impact on the effect of using hair growth treatment.
