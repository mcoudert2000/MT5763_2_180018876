...
Once the data is downloaded to our computer we need to upload it into SAS. Before doing this it's needed to create a PROJECT2 file to store our data in and make sure you use your file path for 

```
PROC IMPORT OUT= PROJECT2.Baldy 
            DATAFILE= "C:\Users\mjc34\Desktop\Baldy.csv" \* Your file path here!!! \*
            DBMS=CSV REPLACE; \* Reads in a .csv file and tells SAS to replace 
     GETNAMES=YES;
     DATAROW=2; 
RUN;
```
